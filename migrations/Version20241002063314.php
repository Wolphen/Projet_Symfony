 ...
 */
final class Version20241002063314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD sender_id INT DEFAULT NULL, ADD receiver_id INT NOT NULL, ADD product_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE notification ADD user_id INT DEFAULT NULL, ADD product_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE product ADD user_id INT NOT NULL, ADD category_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP sender_id, DROP receiver_id, DROP product_id');
        ...
        $this->addSql('ALTER TABLE notification DROP user_id, DROP product_id');
